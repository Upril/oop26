...
public class PersonWithParentStrings {
    ...
    public static PersonWithParentStrings fromCsvLine(String line) throws NegativeLifespanException {
        ...
        return new PersonWithParentStrings(person,
    ...
    public static void connectRelatives(Map<String,
            PersonWithParentStrings> peopleMap){
    ...
    public static List<Person> unpackMap(
            Map<String, PersonWithParentStrings> people){
